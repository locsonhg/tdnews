...
const SinglePost = () => {
  ...
  const saveToServer = async (file) => {
    ...
    body.append("upload_preset", "ovfn9usr");
    const uploadRes = await axios.post(
      "https://api.cloudinary.com/v1_1/doylwhphq/image/uploadd",
      body
    );
      ...
      try {
        const list = await Promise.all(
          Object.values(files).map(async (file) => {
            ...
            data.append("upload_preset", "ovfn9usr");
            const uploadRes = await axios.post(
              "https://api.cloudinary.com/v1_1/doylwhphq/image/upload",
              data,
              options
            );
